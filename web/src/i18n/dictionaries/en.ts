export const en = {
  ...
  footer: {
    ...
    emailTbc: "Email: to be confirmed",
  ...
  home: {
    ...
    tours: {
      ...
      ctaResorts: "See the Resorts on Tour",
    },
    resorts: {
      kicker: "The Resorts",
    ...
    partners: {
      kicker: "Partners",
      title: "Alongside our resort partners & TTM Maldives",
  ...
  about: {
    ...
    selectionModel: {
      ...
      title: "Merit-based, driven by room-nights",
      steps: [
        {
          number: "01",
  ...
  programmePdf: {
    ...
    title: "Download the full programme",
    body: "The detailed itinerary, day-by-day programme and participant information. Tell us where to send it and the download starts straight away.",
    versionLabel: "Version",
    nameLabel: "Full name",
    emailLabel: "Email",
    cta: "Download the programme",
    sending: "Preparing...",
    sentTitle: "Your download has started",
    sentBody: "If it did not begin automatically, check your browser's downloads. Our team will follow up.",
  ...
  partnersPage: {
    banner: {
      kicker: "Partners",
      title: "The resorts and events behind the programme",
      body: "We Present exists because of the resort partners who host each tour and the trade events that bring the industry together.",
    },
    resortPartners: {
      kicker: "Resort Partners",
      title: "Four islands, one tour",
    },
    associated: {
  ...
  contactPage: {
    ...
    details: {
      ...
      office: "Offices",
      showMap: "Show map",
      // Named so a screen-reader user knows which office a map control belongs to.
      showMapFor: "Show map for",
      instagram: "Instagram",
      instagramHandle: "@wepresentproject",
    ...
    enContact: {
      title: "Get in Touch",
      body: "Message us on WhatsApp or call directly, and our team will follow up.",
      emailCta: "Email Us",
    },
  },
  resortPage: {
    ...
    officialWebsiteTbc: "To be confirmed by resort partner",
    gallery: "Gallery",
    lifeAt: "Life at",
  ...
  forms: {
    ...
    contact: {
      ...
      inquiryTypePrivate: "Private Trip",
